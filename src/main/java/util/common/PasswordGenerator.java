...
public class PasswordGenerator {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println(
                    "UPDATE SAUSERM SET PSWRD = '" + encryptedPassword + "' WHERE USER_ID = '" + userId + "';");
     ...
     */
    public static String calculateEncryptedPasswordWithBigDecimal(Encryption encryption, String userId, String password)
            throws Exception {
...
// String[][] testUsers = {
// {"EE1COMSAB", "test123", "798417496258042500839631391132765.3135"}, //
// Working 9-char
// {"DEO1COMCP", "test123", "798417396263611194291322482889724.9149"} // Not
// working 9-char
// };
//
...
// }
//
// public static void analyzeCharacterByCharacter(Encryption encryption, String
// userId, String password, String storedEncryptedPassword) throws Exception {
...
// System.out.println("Username encrypted length: " +
// encryptedUsername.length());
// System.out.println("Password encrypted length: " +
// encryptedPassword.length());
//
// // Test the validation with detailed logging
// System.out.println("\nVALIDATION TEST:");
// testValidationWithLogging(encryption, userId, password,
...
// }
//
// public static void testValidationWithLogging(Encryption encryption, String
// userId, String password, String storedEncryptedPassword) throws Exception {
// // Simulate the exact validation logic with detailed logging
// String encryptedPasswordStr = encryption.checkPass(password);
// String encryptedUsernameStr =
// encryption.checkPass(userId.trim().toUpperCase());
//
...
//
// boolean result = encryption.validateLogin(userId, password,
// storedEncryptedPassword);
